// 📄 /home/hope/Desktop/reactNative/client/Blue_Injera/blue_injera_ordering/app/(tabs)/_layout.tsx
...
const TabBarIcon = ({ focused, icon, title }: TabBarIconProps) => (
  <View className="tab-icon">
    <Image source={icon} className="size-7" resizeMode="contain" tintColor={focused ? " #34a9ca" : '#5D5F6D'} />
...
export default function TabLayout() {
  ...
  // 🔹 At this point, auth is guaranteed ready (thanks to root layout)
  if (!isAuthenticated) {
